...
vim.opt.compatible = false                                       -- No compatible with vi (Never remove this line)
...
vim.opt.relativenumber = true                                    -- Show the line number relative to the current line
vim.opt.scrolloff = 5                                            -- Scroll with 8 lines at the end of the page
